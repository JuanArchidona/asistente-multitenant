# Bitácora — Entrega 3.3 (Evaluación de agentes) · ARCHIVO

> Histórico de la entrega de la que parte este repositorio. Se conserva
> porque explica de dónde salen el banco y el sistema heredados. La bitácora
> viva del proyecto es `BITACORA.md`.
